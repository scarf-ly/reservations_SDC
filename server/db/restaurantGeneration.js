...
const generateData = () => {
    ...
    restaurantsArr.push(restaurant_name, min_reservation_size, max_reservation_size, reservation_length, open_time, close_time, available_seats);
    ...
    for (let i = 0; i < reservation_count; i++) {
      ...
      reservationsArr.push(count, user_id, timestamp, reservation_size);
...
const reservationsWriteStream = fs.createWriteStream('reservations.csv');
